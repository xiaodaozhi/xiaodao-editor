...
export const HeadingExtension: Extension = {
  ...
  slashCommands: [
    headingSlash('heading-1', 1, 'slash.heading1.title', 'slash.heading1.description', ICON_H1, ['h1', '标题1', '大标题', 'title']),
    headingSlash('heading-2', 2, 'slash.heading2.title', 'slash.heading2.description', ICON_H2, ['h2', '标题2', '小标题']),
    headingSlash('heading-3', 3, 'slash.heading3.title', 'slash.heading3.description', ICON_H3, ['h3', '标题3', 'section']),
    headingSlash('heading-4', 4, 'slash.heading4.title', 'slash.heading4.description', ICON_H4, ['h4', '标题4']),
    headingSlash('heading-5', 5, 'slash.heading5.title', 'slash.heading5.description', ICON_H5, ['h5', '标题5']),
    headingSlash('heading-6', 6, 'slash.heading6.title', 'slash.heading6.description', ICON_H6, ['h6', '标题6']),
  ],
